...
<div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5"><div><h3 class="font-serif text-xl font-bold text-botanica-dark">Pesanan Terbaru</h3><p class="text-xs text-botanica-muted mt-1">Data transaksi checkout terbaru.</p></div><div class="flex items-center gap-4"><a class="inline-flex items-center gap-2 rounded-full bg-clay-500 px-4 py-2.5 text-xs font-semibold text-white shadow-liquid-glow transition hover:bg-clay-600" href="<?= base_url('/admin/laporan/export-pdf') ?>"><span aria-hidden="true">↓</span>Export PDF laporan</a><a class="text-xs font-bold text-clay-600" href="<?= base_url('/admin/transaksi') ?>">Lihat semua pesanan &rarr;</a></div></div>
