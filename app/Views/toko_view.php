...
<body class="bg-background font-body-md text-on-surface min-h-screen relative selection:bg-primary-fixed selection:text-on-primary-fixed">
    ...
    <header class="fixed top-0 inset-x-0 z-50">
        <div class="w-full h-20 bg-surface-container-lowest/65 backdrop-blur-2xl shadow-[0_16px_36px_-8px_rgba(42,30,23,0.08),0_4px_16px_-2px_rgba(42,30,23,0.04)] px-gutter-mobile lg:px-gutter-desktop flex items-center justify-between transition-all">
